var bak = 53;
var bakOst=[];
bakOst[0]= prompt('Сколько бензина в баке, %?', 50);
var probeg = [];
probeg[0] = prompt('Пробег сейчас, км?', 17610);
...
probeg[1] = prompt('Пробег сейчас, км?', 17610);
bakOst[1]= prompt('сколько бензина в баке, %?', 50);
var rashod = [];
